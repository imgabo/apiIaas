...
export class ProcedimientosCirugiasController {
    ...
    constructor(private readonly procedimientocirugiaSvc : ProcedimientosCirugiasService){}
    ...
    @Put(':id')
    async update(@Param('id') id : string, @Body() dto : nuevoProcedimientoCirugiaDTO){
